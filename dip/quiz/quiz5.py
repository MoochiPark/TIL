...
src   = cv2.imread('./data/tiffany512.ppm', cv2.IMREAD_GRAYSCALE)
tmp_A   = cv2.imread('./data/eye.jpg', cv2.IMREAD_GRAYSCALE)
tmp_S   = cv2.imread('./data/nose.jpg', cv2.IMREAD_GRAYSCALE)
tmp_b   = cv2.imread('./data/lip.jpg', cv2.IMREAD_GRAYSCALE)
